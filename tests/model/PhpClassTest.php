 ...
 */');
	...
	public function testInterfaces() {
		...
		$this->assertEquals([], $class->getInterfaces());
	...
	public function testProperties() {
		...
		$this->assertEquals(['bam', 'bar'], $class->getPropertyNames());
