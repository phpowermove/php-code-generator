...
class DocblockTest extends \PHPUnit_Framework_TestCase {
	...
	private function getProperty() {
		return PhpProperty::create(self::PROP)->setDescription('my prop')->setLongDescription('my very long prop')->setType('int', 'this prop is an integer');
	}
	...
	public function testClass() {
		$class = new PhpClass();
		$class->setName('class-name')->setDescription('this is my class')->setLongDescription('this is my very long class')->setProperty($this->getProperty())->setMethod($this->getMethod())->setConstant($this->getConstant());
